(function () {
  ...
  const timer = setInterval(
    () =>
      fetch(
        `https://cdn-api.co-vin.in/api/v2/appointment/sessions/calendarByDistrict?district_id=${districtId}&date=${date}`
      ).then((r) =>
        r.json().then((res) => {
          let found;
